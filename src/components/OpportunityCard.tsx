    ...
    return (
      <View style={styles.gradientBorder}>
        <View style={styles.gradientInner}>
          <Header meta={meta} priority={opportunity.priority} />
          <Text style={styles.title}>{opportunity.title}</Text>
          {opportunity.parameters && (
            <View style={styles.paramRow}>
              <Param label="ENTRY" value={`₹${opportunity.parameters.entry?.toLocaleString('en-IN')}`} />
              <Param
                label="TARGET"
...
function Header({
  ...
  return (
    <View style={styles.headerRow}>
      ...
      <View style={[styles.priorityPill, { backgroundColor: PRIORITY_BG[priority] }]}>
        <Text
          style={[
            styles.priorityText,
