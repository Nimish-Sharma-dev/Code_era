...
const getSeverityColor = (Colors: ColorPalette) => ({
...
export default function TradeXScreen() {
  ...
  const severityColor = getSeverityColor(Colors);
...
const getStyles = (Colors: ColorPalette) =>
  StyleSheet.create({
    ...
    alertBanner: {
      ...
      borderWidth: 1,
      borderColor: `${Colors.loss}4D`,
      backgroundColor: `${Colors.loss}14`,
    },
    alertTextWrap: { flex: 1, gap: 2 },
    alertTitle: { fontFamily: 'Inter_700Bold', fontSize: 13, color: Colors.loss },
    alertBody: { fontFamily: 'Inter_400Regular', fontSize: 11, color: `${Colors.loss}B3` },
