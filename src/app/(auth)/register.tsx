      ...
      >
        <View style={styles.content}>
          <View style={styles.iconBadge}>
            <Icon name="person" size={22} color={Colors.primaryLight} />
          </View>
          <Text style={styles.heading}>Create your account</Text>
          <Text style={styles.subheading}>
            We'll use this to personalize your financial risk assessment.
          </Text>

          <View style={styles.form}>
            <Field label="Full name" value={name} onChangeText={setName} placeholder="Alex Mehta" Colors={Colors} styles={styles} />
            <Field
              label="Email"
              value={email}
          ...
          <View style={styles.footer}>
            <Button label="Continue" icon="arrowRight" onPress={onSubmit} loading={loading} />
          </View>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
